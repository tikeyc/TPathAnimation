package com.tikeyc.tpathanimation.custom.CustomView;
...
import com.tikeyc.tpathanimation.custom.AnimatorPath.AnimatorPath;
import com.tikeyc.tpathanimation.custom.AnimatorPath.PathEvaluator;
import com.tikeyc.tpathanimation.custom.AnimatorPath.PathPoint;
...
//        anim.setRepeatMode(ObjectAnimator.REVERSE);
    ...
    public void setAnimationPropertyName(PathPoint newLoc) {
        setTranslationX(newLoc.mX - 100);
        setTranslationY(newLoc.mY - 60);
...
//        setLayoutParams(layoutParams);
        Log.e("TAG","setAnimationPropertyName");
    }
